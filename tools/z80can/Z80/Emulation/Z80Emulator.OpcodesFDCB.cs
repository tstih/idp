namespace Z80.Emulation
{
	...
	{
		OperationDelegate[] _opcodes_fdcb;

		void InitializeOpcodesFDCB()
		{
			_opcodes_fdcb = new OperationDelegate[] {
		...
		void op_FDCB_0x00()
		{
			Registers.WZ = (ushort)(Registers.IY + _tmpbyte_s);
			_tmpbyte = CPUReadMemory((ushort)(Registers.IY + _tmpbyte_s));
			RLC(ref _tmpbyte);
			LD(ref Registers.B, _tmpbyte);
			CPUWriteMemory((ushort)(Registers.IY + _tmpbyte_s), _tmpbyte);
