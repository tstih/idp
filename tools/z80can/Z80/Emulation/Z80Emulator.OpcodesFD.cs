namespace Z80.Emulation
{
	...
	{
		OperationDelegate[] _opcodes_fd;

		void InitializeOpcodesFD()
		{
			_opcodes_fd = new OperationDelegate[] {
								null      , null      , null      , null      ,
								null      , null      , null      , null      ,
		...
		void op_FD_0x2a()
		{
			...
			LD_RP_FRO_ADDR_MPTR_16(ref Registers.IY, Registers.TD, Registers.TA);
