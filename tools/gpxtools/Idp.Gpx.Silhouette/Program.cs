...
using Idp.Gpx.Silhouette.Commands;

namespace Idp.Gpx.Silhouette
{
    ...
    class Program
    {
        ...
        static void Welcome()
        {
            Console.WriteLine("Welcome to Silhouette.");
        ...
        static void Usage()
        {
            Console.Error.WriteLine("Usage: silhouette <command> <command args>.");
