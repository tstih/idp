namespace Z80.Emulation
{
	...
	{
		OperationDelegate[] _opcodes_ed;

		void InitializeOpcodesED()
		{
			_opcodes_ed = new OperationDelegate[] {
								null      , null      , null      , null      ,
								null      , null      , null      , null      ,
								null      , null      , null      , null      ,
								null      , null      , null      , null      ,
		...
		void op_ED_0x4b()
		{
			...
			LD_RP_FRO_ADDR_MPTR_16(ref Registers.BC, Registers.TD, Registers.TA);
		...
		void op_ED_0x5b()
		{
			...
			Registers.TDl = CPUReadMemory(Registers.TA);
			Registers.TDh = CPUReadMemory((ushort)(Registers.TA + 1));
			LD_RP_FRO_ADDR_MPTR_16(ref Registers.DE, Registers.TD, Registers.TA);
		...
		void op_ED_0x7b()
		{
			...
			Registers.TDl = CPUReadMemory(Registers.TA);
			Registers.TDh = CPUReadMemory((ushort)(Registers.TA + 1));
			LD_RP_FRO_ADDR_MPTR_16(ref Registers.SP, Registers.TD, Registers.TA);
